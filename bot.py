...
async def BotzHub():
    async with user_bot:
        while True:
            ...
            await user_bot.edit_message(int(chnl_id), msg_id, "**@HARP_Tech Bots Status.**\n\n`Performing a periodic check...`")
            c = 0
            edit_text = "**@HARP_Tech Bots Status.**\n\n"
            for bot in bots:
